...
function AddExpense() {
    ...
    const [category, setCategory] = useState("Codzienne wydatki");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetchWithAuth('http://localhost:8080/api/operations/addExpense', {
                method: 'POST',
                headers: {
            ...
            setError('Błąd wprowadzania wydatku')
        }
    };
